...
<!--        <script src="client_mobile/lib/ol3/ol-debug.js?v=4.6.5a"></script>-->
        ...
        <link rel="stylesheet" type="text/css" href="client_mobile/src/viewer.css?v=20181005" />
    ...
    <div data-role="page" id="mappage" data-theme="c">
        ...
        <div data-role="content">
            <div id="map">
                ...
                <a href="#" style="display:none" id="btnGotoPage" data-role="button" data-icon="goto" data-icon="add" data-iconpos="notext" data-rel="dialog" data-theme="e"></a>
            </div>

...
function goMobile($lang) {
 ?><!DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="client_mobile/src/viewer.css?v=20171212" />
    ...
    if($mobile=='on') {
        goMobile($def_lang);
            ...
            <head>
                ...
                <script type="text/javascript" src="client/site/libs/openlayers/OpenLayers.js?v=20171116"></script>

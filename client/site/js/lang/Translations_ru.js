...
modeStreetViewString["ru"] = "Mode: StreetView. Click on the road."; //FIXME
...
backgroundLayerTitleString["ru"] = "Геоподложки";
var externalLayerTitleString = [];
externalLayerTitleString["ru"] = "Дополнительные слои";
...
searchFieldDefaultTextString["ru"] = "Поиск (название, напряжение)";
...
measurementsWindowTitleString["ru"] = "Measurements";
var measurementsTotalLabelString = [];
measurementsTotalLabelString["ru"] = "Total";
var measurementsLinePrefixString = [];
measurementsLinePrefixString["ru"] = "line";
var measurementsAreaPrefixString = [];
measurementsAreaPrefixString["ru"] = "area";
...
sendPermalinkTooltipString["ru"] = "Создать гиперссылку на текущую карту";
var sendPermalinkLinkFromString = [];
sendPermalinkLinkFromString["ru"] = "Ссылка на текущую карту";
...
clickPopupTitleString["ru"] = "Результаты"
var contextZoomLayerExtent = [];
contextZoomLayerExtent["ru"] = "Масштабировать по содержимому";
var contextOpenTable = [];
contextOpenTable["ru"] = "Открыть таблицу атрибутов";
var contextDataExport = [];
contextDataExport["ru"] = "Экспортировать слой в...";
var contextUseExtent = [];
contextUseExtent["ru"] = "Использовать охват текущей карты";

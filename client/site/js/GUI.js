				...
				items: [{
					...
					tbar: {
						...
						items: [{
							...
							enableToggle: true,
							icon: iconDirectory+'mActionIdentify.svg',
							allowDepress: true,
							tooltipType: 'qtip',
							iconCls: '',
							scale: 'medium',
                        ...
                        //    id: 'separator2'
							...
							allowDepress: true,
							toggleGroup: 'mapTools',
							icon: iconDirectory+'mActionMeasure.svg',
							...
							toggleGroup: 'mapTools',
							scale: 'medium',
							icon: iconDirectory+'mActionMeasureArea.svg',
							tooltipType: 'qtip',
							...
							toggleGroup: 'mapTools',
							scale: 'medium',
							icon: iconDirectory+'mActionFilePrint.svg',
							tooltipType: 'qtip',
							...
							allowDepress: false,
							scale: 'medium',
							icon: iconDirectory+'mActionPermalink.svg',
							tooltipType: 'qtip',
						...
						,   {
                                ...
                                allowDepress: false,
                                scale: 'medium',
                                icon: iconDirectory+'mActionMailSend.svg',
                                tooltipType: 'qtip',
                                tooltip: TR.feedback,
                                id: 'ShowFeedback',

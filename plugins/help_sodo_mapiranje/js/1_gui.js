...
Eqwc.plugins["help_sodo_mapiranje"] = {};
Eqwc.plugins["help_sodo_mapiranje"].customToolbarLoad = function() {

    var btn = Ext.getCmp('helpSodoBtn');
    btn.setHandler(newWindow);

    function newWindow() {
        var url = "https://sodo.si/storage/app/media/Navodila za uporabo spletne aplikacije SODOKart.pdf?n=" + getRandomNum();
        window.open(url);
    }

...
Eqwc.plugins["help_ie_jalzabet_jr"] = {};
Eqwc.plugins["help_ie_jalzabet_jr"].customToolbarLoad = function() {

    var btn = Ext.getCmp('helpIeJalzabetActionBtn');
    btn.setHandler(newWindow);

    function newWindow() {
        var url = "plugins/help_ie_jalzabet_jr/Svjetiljke_Jalzabet.pdf?n="+getRandomNum();
        window.open(url);
    }

/**
 * Norwegian translation for Extended Qgis Web Client
 *
 * Translators
 *
 * Date
...
var TR = {
    ...
    loginRememberMeLabel: 'Husk meg på denne datamaskinen',
    loginForgotPasswordLabel: 'Glemt passord?',
    logoutLabel: 'Logg ut',
    noProject: 'Prosjektet eksisterer ikke. ',
    noProjectText: 'Legg til riktig prosjektnavn og last siden på nytt.',
    ...
    generateReport: 'Generer Word-rapport',
    ...
    tableMeasurementFilterCurrentTable: "Filtrer gjeldende tabell",
    measurementZoomTooltip: "Zoom til element",
    measurementRemoveTooltip: "Slett",
    measurementRemoveAllTooltip: "Slett alle",
    measurementProfileTitle: "Høydeprofil",
    measurementProfilePositionLayer: "Posisjon i høydeprofil",
    measurementProfileMoveHint: "Flytt pekeren over profilen for å vise detaljer.",
    measurementProfileDistance: "Avstand",
    measurementProfileElevation: "Høyde",
    measurementProfileNextSlope: "Helning på neste segment",
    measurementProfileNoData: "ingen data",
    measurementProfileUnavailable: "Svaret inneholder ingen brukbar høydeprofil.",
    measurementProfileCreateError: "Høydeprofilen kan ikke opprettes.",
    measurementProfileLoading: "Laster høydeprofil...",
    measurementProfileRequestFailed: "Forespørselen om høydeprofil mislyktes.",
    measurementProfileAriaLabel: "Høydeprofil for linje",
    ...
    bookmarks: "Bokmerker",
    bookmarkName: "Navn",
    bookmarkGroup: "Gruppe",
    bookmarkEmptyGroupText: "ingen gruppe",
    bookmarkAdd: "Legg til",
    bookmarkEdit: "Rediger",
    bookmarkRemove: "Fjern",
    bookmarkRemoveConfirm: "Vil du fjerne dette bokmerket?",
    bookmarkSave: "Lagre",
    bookmarkStorageError: "Bokmerket kunne ikke lagres i denne nettleseren.",
    link: "LINK",
    trueText: 'Yes',
    falseText: 'No',
    close: 'Close',
...
I18n.featureInfo = {
    ...
    feature: "Funksjon ID:",
    raster: "Raster",
    noFeatureFound: "Ingen objekter funnet"
};
